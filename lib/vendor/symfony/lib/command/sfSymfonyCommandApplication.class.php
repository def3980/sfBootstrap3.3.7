 ...
 * Jueves, 25 Septiembre 2014 11:10:11
 * + ------------------------------------------------------------------- +
 */
...
class sfSymfonyCommandApplication extends sfCommandApplication {
    ...
    /**
     * Configura el actual comando de aplicacion de su}ymfony
     */
    public function configure() {
        if (!isset($this->options['symfony_lib_dir'])) {
            throw new sfInitializationException('Se debe pasar una opcion "symfony_lib_dir".');
        }
    ...
    /**
     * Corre la aplicacion actual.
     *
     * @param mixed $options Las opciones de la linea de comandos
     *
     * @return integer 0 Si todo fue bien, o codigo de error
     */
