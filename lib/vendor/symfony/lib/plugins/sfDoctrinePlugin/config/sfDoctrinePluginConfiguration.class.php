 ...
 * Jueves, 25 Septiembre 2014 17:46:17
 * + ------------------------------------------------------------------- +
 */
...
class sfDoctrinePluginConfiguration extends sfPluginConfiguration {
    ...
    public function initialize() {
        ...
        // aplicando atributos por defecto
        ...
        // asegurandonos que la cultura(traductor || internacionalizacion) es interceptada
        $this->dispatcher->connect('user.change_culture', array('sfDoctrineRecord', 'listenToChangeCultureEvent'));
    }

    /**
     * Devuelve las opciones para el constructor de esquema Doctrine.
     *
     * @return array
     */
    ...
    /**
     * Devuelve una matriz de configuracion para la linea de comandos Doctrine.
     *
     * @return array
     */
