 ...
 * Sábado, 20 Agosto 2016 10:34:59
 * + ------------------------------------------------------------------- +
 */
...
class sfProjectConfiguration {
    ...
    public function setRootDir($rootDir) {
        ...
        sfConfig::add(array(
            ...
            // Por Oswaldo Rojas - Jue 25 Sep 2014 16:48:37
            'sf_docs_dir'    => $rootDir.DIRECTORY_SEPARATOR.'docs',
        ));
    ...
    /**
     * Guarda la raiz del directorio web.
     *
     * @param string $webDir La ruta absoluta para el directorio web.
     */
