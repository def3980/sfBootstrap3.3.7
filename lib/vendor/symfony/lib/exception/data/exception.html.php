 ...
 * Martes, 07 Octubre 2014 13:07:26
 * + ------------------------------------------------------------------- + */
?>
    ...
    <body>
        <center>
            <div id="main">
                ...
                <h2>Ruta del error</h2>
                <ul>
                    <li><?php echo implode('</li><li>', $traces) ?></li>
                </ul>
                <h2>configuraciones de symfony<a href="#" onclick="toggle('sf_settings'); return false;">...</a></h2>
                <div id="sf_settings" style="display: none"><?php echo $settingsTable ?></div>
                <h2>petici&oacute;n (request) <a href="#" onclick="toggle('sf_request'); return false;">...</a></h2>
                <div id="sf_request" style="display: none"><?php echo $requestTable ?></div>
                <h2>respuesta (response) <a href="#" onclick="toggle('sf_response'); return false;">...</a></h2>
                <div id="sf_response" style="display: none"><?php echo $responseTable ?></div>
                <h2>usuario <a href="#" onclick="toggle('sf_user'); return false;">...</a></h2>
                <div id="sf_user" style="display: none"><?php echo $userTable ?></div>
                <h2>varibles globales <a href="#" onclick="toggle('sf_globals'); return false;">...</a></h2>
                ...
                <p id="footer">
                    ...
                    para resolver este problema, por favor visite <a href="http://www.symfony-project.org/">http://www.symfony-project.org/</a>.
                </p>
            </div>
        </center>
    </body>
