...
class sfFilesystem
{
  ...
  public function execute($cmd, $stdoutCallback = null, $stderrCallback = null)
  {
    ...
    /**
     * Reemplaza tokens en un arreglos de archivos.
     *
     * @param array  $files       Un arreglo de nombres de archivos
     * @param string $beginToken  El comienzo del token delimitador
     * @param string $endToken    El final del token delimitador
     * @param array  $tokens      Un arreglo par de tokens o valores
     */
