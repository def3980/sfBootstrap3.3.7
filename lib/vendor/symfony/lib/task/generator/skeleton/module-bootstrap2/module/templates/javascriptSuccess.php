<?php slot('titulo', 'Javascript &middot; Bootstrap') ?>
<?php include_partial('bootstrap_navbar', array('ruta' => '@bootstrap2_javascript')) ?>
        <!-- Subhead ================================================== -->
...
<?php include_partial('bootstrap_heads-up') ?>
            ...
            <div class="row">
                ...
                <div class="span9">
                    <!-- Overview ================================================== -->
                    <section id="overview">
                        <div class="page-header"><h1>JavaScript in Bootstrap</h1></div>
...
$('#myModal').on('show', function(e) {
    if (!data) return e.preventDefault();   // stops modal from being shown
                    ...
                    <section id="transitions">
                        <div class="page-header"><h1>Transitions <small>bootstrap-transition.js</small></h1></div>
                    ...
                    <!-- Modal ================================================== -->
                    <section id="modals">
                        <div class="page-header"><h1>Modals <small>bootstrap-modal.js</small></h1></div>
                        <h2>Examples</h2>
...
$('#myModal').on('hidden', function() {
    // do something…
                    ...
                    <section id="dropdowns">
                        <div class="page-header"><h1>Dropdowns <small>bootstrap-dropdown.js</small></h1></div>
                        <h2>Examples</h2>
...
<pre class="prettyprint linenums">$('.dropdown-toggle').dropdown();</pre>
                    ...
                    <section id="scrollspy">
                        <div class="page-header"><h1>ScrollSpy <small>bootstrap-scrollspy.js</small></h1></div>
...
$('[data-spy="scroll"]').each(function () {
    var $spy = $(this).scrollspy('refresh');
                    ...
                    <!-- Tabs ================================================== -->
                    <section id="tabs">
                        <div class="page-header"><h1>Togglable tabs <small>bootstrap-tab.js</small></h1></div>
                        <h2>Example tabs</h2>
...
$('a[data-toggle="tab"]').on('shown', function(e) {
    ...
    e.relatedTarget   // previous tab
                    ...
                    <!-- Tooltips ================================================== -->
                    <section id="tooltips">
                        <div class="page-header"><h1>Tooltips <small>bootstrap-tooltip.js</small></h1></div>
                        <h2>Examples</h2>
...
<pre class="prettyprint linenums">$('#element').tooltip('destroy');</pre>
                    ...
                    <!-- Popovers ================================================== -->
                    <section id="popovers">
                        <div class="page-header"><h1>Popovers <small>bootstrap-popover.js</small></h1></div>
                        <h2>Examples</h2>
...
<pre class="prettyprint linenums">$('#element').popover('destroy');</pre>
                    ...
                    <section id="alerts">
                        ...
                        <h1>Alert messages <small>bootstrap-alert.js</small></h1></div>
...
$('#my-alert').bind('closed', function() {
    // do something…
                    ...
                    <!-- Buttons ================================================== -->
                    <section id="buttons">
                        <div class="page-header"><h1>Buttons <small>bootstrap-button.js</small></h1></div>
                        <h2>Example uses</h2>
...
<pre class="prettyprint linenums">&lt;button type="button" class="btn" data-loading-text="loading stuff..." &gt;...&lt;/button&gt;</pre>
                    <div class="alert alert-info">
                        <strong>Heads up!</strong>
                        <?=link_to('Firefox persists the disabled state across page loads', 'https://github.com/twbs/bootstrap/issues/793')?>. A workaround for this is to use <code>autocomplete="off"</code>.
                    </div>
                    <h4>$().button('reset')</h4>
...
&lt;/script&gt;
                    ...
                    <!-- Collapse ================================================== -->
                    <section id="collapse">
                        <div class="page-header"><h1>Collapse <small>bootstrap-collapse.js</small></h1></div>
                        <h3>About</h3>
...
$('#myCollapsible').on('hidden', function() {
    // do something…
                    ...
                    <!-- Carousel ================================================== -->
                    <section id="carousel">
                        <div class="page-header"><h1>Carousel <small>bootstrap-carousel.js</small></h1></div>
                            ...
                            <div id="myCarousel" class="carousel slide">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <?php echo image_tag('bootstrap-mdo-sfmoma-01.jpg').PHP_EOL ?>
                                    ...
                                    <div class="item">
                                        <?php echo image_tag('bootstrap-mdo-sfmoma-02.jpg').PHP_EOL ?>
                                        <div class="carousel-caption">
                                    ...
                                    <div class="item">
                                        <?php echo image_tag('bootstrap-mdo-sfmoma-03.jpg').PHP_EOL ?>
                                        <div class="carousel-caption">
...
$('.carousel').carousel({
    interval: 2000
                    ...
                    <section id="typeahead">
                        <div class="page-header"><h1>Typeahead <small>bootstrap-typeahead.js</small></h1></div>
                        <h2>Example</h2>
...
<pre class="prettyprint linenums">$('.typeahead').typeahead();</pre>
                    ...
                    <!-- Affix ================================================== -->
                    <section id="affix">
                        <div class="page-header"><h1>Affix <small>bootstrap-affix.js</small></h1></div>
                        <h2>Example</h2>
