...
<?php include_partial('bootstrap_navbar', array('ruta' => '@bootstrap2_getting_started')) ?>
        <!-- Subhead ================================================== -->
            ...
            <div class="row">
                ...
                <!-- Download ================================================== -->
                    <section id="download-bootstrap">
                        <div class="page-header"><h1>1. Download</h1></div>
                        <p class="lead">Before downloading, be sure to have a code editor (we recommend <?php echo link_to('Sublime Text 2', 'http://sublimetext.com/2') ?>) and some working knowledge of HTML and CSS. We won't walk through the source files here, but they are available for download. We'll focus on getting started with the compiled Bootstrap files.</p>
                        <div class="row-fluid">
                            <div class="span6">
                            ...
                            <div class="span6">
                                ...
                                <p><?php echo link_to('Download Bootstrap source', 'https://github.com/twbs/bootstrap/archive/v2.3.2.zip', array('class' => 'btn btn-large')) ?></p>
                            </div>
                        </div>
                    </section>
                    <!-- File structure ================================================== -->
                    <section id="file-structure">
                        <div class="page-header"><h1>2. File structure</h1></div>
...
<pre class="prettyprint">
  ...
  └── glyphicons-halflings-white.png
                    ...
                    <!-- Contents ================================================== -->
                    <section id="contents">
                        <div class="page-header"><h1>3. What's included</h1></div>
                        <p class="lead">Bootstrap comes equipped with HTML, CSS, and JS for all sorts of things, but they can be summarized with a handful of categories visible at the top of the <?php echo link_to('Bootstrap documentation', 'http://getbootstrap.com') ?>.</p>
                        <h2>Docs sections</h2>
                        <h4><a href="./scaffolding.html">Scaffolding</a></h4>
                        <p>Global styles for the body to reset type and background, link styles, grid system, and two simple layouts.</p>
                        <h4><a href="./base-css.html">Base CSS</a></h4>
                        <p>Styles for common HTML elements like typography, code, tables, forms, and buttons. Also includes <?php echo link_to('Glyphicons', 'http://glyphicons.com') ?>, a great little icon set.</p>
                    ...
                    <section id="html-template">
                        <div class="page-header"><h1>4. Basic HTML template</h1></div>
...
&lt;/html&gt;
                    ...
                    <!-- Examples ================================================== -->
                    <section id="examples">
                        <div class="page-header"><h1>5. Examples</h1></div>
