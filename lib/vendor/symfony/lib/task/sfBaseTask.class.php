...
abstract class sfBaseTask extends sfCommandApplicationTask
{
  ...
  protected function initializeAutoload(sfProjectConfiguration $configuration, $reload = false)
  {
    ...
    /**
     * Refleja una estructura de directorios dentro del proyecto creado.
     *
     * @param string   $dir    El directorio donde realizar la copia de archivos
     * @param sfFinder $finder Una instancia sfFinder para usar en la copia de archivos
     */
    ...
    /**
     * Sustituye el caracter indicado (tokens) en los archivos que se encuentran
     * en el directorio indicado.
     *
     * todos los archivos que esten dentro del directorio config/ y lib/
     *
     * Se puede definir tokerns globales llenando las propiedades $this->tokens
     *
     * @param array $dirs   Un arreglo de directorios donde realizar el cambio
     * @param array $tokens Un arreglo de tokens a usar
     */
  ...
  protected function reloadTasks()
  {
    ...
    /**
     * Activa un plugin en la clase ProjectConfiguration.
     *
     * @param string $plugin El nombre del plugin
     */
    ...
    /**
     * Desactiva un plugin en la clase ProjectConfiguration.
     *
     * @param string $plugin El nombre del plugin
     */
