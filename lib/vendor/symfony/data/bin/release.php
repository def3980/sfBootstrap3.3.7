...
/**
 * Por Oswaldo Rojas
 * Empezado a modificar un Miércoles, 20 Enero 2016 21:35:39
 * Terminado un Miércoles, 20 Enero 2016 21:45:17
 */
...
foreach ($dirs as $dir => $role) {
    ...
    foreach ($class_files as $file) {
        $xml_classes .= '<file role="'
                        .$role.'" baseinstalldir="symfony" install-as="'
                        .$file.'" name="'.$dir.'/'.$file.'" />'
                        ."\n";
    }
}
...
$filesystem
    ->replaceTokens(
        getcwd().DIRECTORY_SEPARATOR.'package.xml', '##', '##', array(
